...
-- ROQC -----------------------
vim.g.python3_host_prog = "/nix/store/2jz0gx1p09n2x2f1xx8735n2lxgdglg2-python3-3.13.12-env/bin/python3"

-- Lazi Nvim
-- Fix runtimepath for NixOS + Lazy + Treesitter
require("config.lazy")
