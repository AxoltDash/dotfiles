...
case "$choice" in
    ...
    "FCiencias")
        ...
        ;;
    "Ingleishon")
        nohup xdg-open https://ingles.fciencias.unam.mx/cursos/course/view.php?id=2690 >/dev/null 2>&1 &
        ;;
    "DeepSeek")
    ...
    "Gemini")
        ...
        ;;
    "Claude")
        nohup xdg-open https://claude.ai/new >/dev/null 2>&1 &
        ;;
	"Lumo")
    ...
    "Gmail")
        ...
        ;;
	"Tuta Email")
		nohup xdg-open https://app.tuta.com/mail/Oip5uiU-2--9 >/dev/null 2>&1 &
		;;
	"Proton Email")
		nohup xdg-open https://mail.proton.me/u/0/inbox?welcome=true >/dev/null 2>&1 &
		;;
	"bitwarden")
		nohup xdg-open https://vault.bitwarden.com/#/vault >/dev/null 2>&1 &
		;;
    "GitHub")
    ...
    "Godot OpenGL3")
        ...
        ;;
	"Zoom")
		nohup xdg-open https://cuaed-unam-mx.zoom.us/j/87983815781 >/dev/null 2>&1 &
		;;
	"Gitmoji")
	...
	"CSES")
		...
		;;
	"Competitive Guide")
		nohup zathura Documents/books/competitive/handbook_cp.pdf  >/dev/null 2>&1 &
		;;
    *)
        exit 1
        ;;
